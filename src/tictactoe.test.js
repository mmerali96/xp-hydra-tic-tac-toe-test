...
describe('tic tac toe tests', () => {
  ...
  describe('test the checkBoard function', () => {
    ...
    it('should return player O if it has a 3 marks in a row for column 2', () => {
    ...
    it('should return false if there is no winner on the board', () => {
      expect(tictactoe.checkBoard()).toBe(false);
    });
  });
});
